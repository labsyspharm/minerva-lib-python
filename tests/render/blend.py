...
from tests.common.colors import (color_white, color_red, color_orange,
                                 color_yellow, color_blue)

from tests.common.ranges import range_all, range_high, range_low
...
def test_channel_range_high(u16_3value_channel, f32_3value_rgb_buffer):
...
def test_channel_range_low(u16_3value_channel, f32_3value_rgb_buffer):
...
def test_channel_color_red(u16_3value_channel, f32_3value_rgb_buffer):
...
def test_channel_color_white(u16_3value_channel, f32_3value_rgb_buffer):
...
def test_channel_target_is_out(u16_3value_channel, f32_3value_rgb_buffer):
...
def test_channel_color_orange(u16_3value_channel, f32_3value_rgb_buffer):
...
def test_channel_orange_low(u16_3value_channel, f32_3value_rgb_buffer):
...
def test_channels_size_mismatch():
